...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{resources/timing-model-in-out.eps}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.7\textwidth]{resources/DTW-transition.eps}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\textwidth]{resources/DTNP-as-gesture-planner.eps}
