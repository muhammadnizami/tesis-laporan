...
Tabel \ref{tab-freq-model-subset-results} menunjukkan \blindtext
\begin{table}[h]
    \centering
...
Tabel \ref{tab-stoc-model-subset-results} menunjukkan \blindtext
\begin{table}[h]
    \centering
...
Tabel \ref{tab-freq-testing-results} \blindtext
\begin{table}[h]
    \centering
